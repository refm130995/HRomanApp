...
export class Step2formPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private alertCtrl: AlertController, private camera: Camera, private service: ServicesProvider, private storage: Storage, private loadingCtrl: LoadingController, private toastCtrl: ToastController) {
  ...
  this.storage.get('User').then((result) => {
    ...
    this.service.SaveInform(this.form, result.token).subscribe((resp) => {
     loading.dismiss();
